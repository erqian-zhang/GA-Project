...
import {setProductAmount,removeFromCart,numberofDiffProductsinCart,productArrayinCart,totalPrice,totalNumberOfProducts } from './myStoreReducerSlice'
        ...
        <div className='Shopping__Cart__Main'>
          ...
          <div className='Shopping__Cart_footer'>
            <div className='Shopping__Cart_footer_button'>
              <Link to = '/'>
              <button className='Shopping__Cart_footer_button2'>Continues Shopping</button>
              </Link>
            </div>
